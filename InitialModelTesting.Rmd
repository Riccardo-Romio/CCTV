...
dependenceTree <- build_dependence_tree(package_network, package = "cranly") #problem is how to use a vector as feature, to be fixed later

test = summary(dependenceTree)
test
```
```{r}
...
model <- multinom(taskView ~ ., data = train, MaxNWts = 25000, maxit = 1500)
```
